...
<html>
  ...
  <body>
    ...
    <p>
    Anonymous online audio recording tool based on <a href="https://github.com/higuma/web-audio-recorder-js">WebAudioRecorder.js</a>
...
<h3>Record <?php echo($_GET['record']); echo($content)?>
    <div id="controls">
